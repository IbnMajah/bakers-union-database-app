<template>
  ...
  <svg v-else-if="name === 'payments' || name === 'credit-card'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2 4h16v2H2V4zm0 4h16v2H2V8zm0 4h16v2H2v-2zm0 4h16v2H2v-2zm18-8v12H0V8h20zm-2 10H2v-2h16v2z" /></svg>
</template>
